...
public class JavaApp extends JFrame implements ActionListener
{
    ...
    public Questions questApp = new Questions();
    ...
    String getQuiz(int quizNumber){
        return questApp.questions.get(quizNumber);
    }
    public static void main(String s[])
    {
        new JavaApp("Online Test Of Java");
    }
    //test
}
