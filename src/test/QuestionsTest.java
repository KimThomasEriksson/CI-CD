...
class QuestionsTest {
    ...
    void question() {
        ...
        assertEquals("Fråga 7: Vilken av dessa är en klass?", question.questions.get(6));
        assertEquals("Fråga 8: Vilken av dessa är inte en funktion av objekt klass", question.questions.get(7));
